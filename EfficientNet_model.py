...
class EnhancedEfficientNet(nn.Module):
    def __init__(self, num_classes):
        ...
        # EfficientNet의 features 부분만 사용 (classifier 제외)
        self.features = efficientnet.features
        
        # EfficientNet-B0의 마지막 feature map은 1280 channels
    ...
    def forward(self, x):
        x = self.features(x)  # EfficientNet feature extraction
        
        x = self.conv1x1(x)  # 채널 수 조정: 1280 → 1024
