...
class EnhancedDenseNet(nn.Module):
    def __init__(self, num_classes):
        ...
        # DenseNet의 features 부분만 사용 (classifier 제외)
        self.features = densenet.features
        
        # DenseNet121의 마지막 feature map은 1024 channels
        # 1x1 convolution으로 채널 수 조정 (필요시)
    ...
    def forward(self, x):
        x = self.features(x)  # DenseNet feature extraction
